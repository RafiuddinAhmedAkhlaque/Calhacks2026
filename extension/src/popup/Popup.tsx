...
import { CorrectQuestions } from "./pages/CorrectQuestions";
...
export function Popup() {
  ...
  switch (page.name) {
    ...
    case "dashboard":
      return (
        <Dashboard
          ...
          onOpenCorrectQuestions={() => setPage({ name: "correctQuestions" })}
    ...
    case "correctQuestions":
      return <CorrectQuestions onBack={() => setPage({ name: "dashboard" })} />;
  }
}
